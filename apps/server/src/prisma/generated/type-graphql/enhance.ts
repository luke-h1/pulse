...
const inputsInfo = {
  ...
  ProjectCreateNestedManyWithoutAuthorInput: [
    'create',
    'connectOrCreate',
    'createMany',
    'connect',
  ...
  ProjectUpdateManyWithoutAuthorNestedInput: [
    'create',
    'connectOrCreate',
    'upsert',
    'createMany',
  ...
  UserUpdateOneRequiredWithoutProjectsNestedInput: [
    'create',
    'connectOrCreate',
    'upsert',
    'connect',
