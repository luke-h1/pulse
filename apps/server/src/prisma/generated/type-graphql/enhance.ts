...
const outputsInfo = {
  ...
  UserGroupBy: ["id", "provider", "firstName", "lastName", "email", "username", "password", "image", "role", "github", "website", "twitter", "bio", "location", "accountStatus", "createdAt", "updatedAt", "_count", "_min", "_max"],
  ...
  ProjectCountAggregate: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "authorId", "createdAt", "updatedAt", "_all"],
  ProjectMinAggregate: ["id", "title", "intro", "image", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "status", "authorId", "createdAt", "updatedAt"],
...
const inputsInfo = {
  ...
  ProjectOrderByWithRelationAndSearchRelevanceInput: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "authorId", "createdAt", "updatedAt", "author", "_relevance"],
  ProjectWhereUniqueInput: ["id", "AND", "OR", "NOT", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "authorId", "createdAt", "updatedAt", "author"],
  ProjectOrderByWithAggregationInput: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "authorId", "createdAt", "updatedAt", "_count", "_max", "_min"],
  ProjectScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "authorId", "createdAt", "updatedAt"],
  PostWhereInput: ["AND", "OR", "NOT", "id", "title", "intro", "image", "tags", "content", "status", "authorId", "createdAt", "updatedAt", "author"],
  PostOrderByWithRelationAndSearchRelevanceInput: ["id", "title", "intro", "image", "tags", "content", "status", "authorId", "createdAt", "updatedAt", "author", "_relevance"],
  ...
  ProjectUpdateInput: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "createdAt", "updatedAt", "author"],
  ProjectCreateManyInput: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "authorId", "createdAt", "updatedAt"],
  ProjectUpdateManyMutationInput: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "createdAt", "updatedAt"],
  PostCreateInput: ["id", "title", "intro", "image", "tags", "content", "status", "createdAt", "updatedAt", "author"],
  ...
  UserMinOrderByAggregateInput: ["id", "provider", "firstName", "lastName", "email", "username", "password", "image", "role", "github", "website", "twitter", "bio", "location", "accountStatus", "createdAt", "updatedAt"],
  ...
  ProjectCountOrderByAggregateInput: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "authorId", "createdAt", "updatedAt"],
  ProjectMaxOrderByAggregateInput: ["id", "title", "intro", "image", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "status", "authorId", "createdAt", "updatedAt"],
  ProjectMinOrderByAggregateInput: ["id", "title", "intro", "image", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "status", "authorId", "createdAt", "updatedAt"],
  ...
  ProjectCreateWithoutAuthorInput: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "createdAt", "updatedAt"],
  ...
  ProjectScalarWhereInput: ["AND", "OR", "NOT", "id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "authorId", "createdAt", "updatedAt"],
