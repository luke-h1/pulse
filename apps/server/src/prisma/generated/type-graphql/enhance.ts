...
const inputsInfo = {
  ...
  ProjectOrderByWithRelationInput: ["id", "title", "slug", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "authorId", "createdAt", "updatedAt", "author"],
  ...
  PostOrderByWithRelationInput: ["id", "title", "slug", "intro", "image", "tags", "content", "status", "authorId", "createdAt", "updatedAt", "author"],
