...
const modelsInfo = {
  ...
  Project: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
  Post: ["id", "title", "intro", "image", "tags", "content", "status", "readingTime", "authorId", "createdAt", "updatedAt"]
};
...
const outputsInfo = {
  ...
  ProjectGroupBy: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "authorId", "createdAt", "updatedAt", "_count", "_min", "_max"],
  AggregatePost: ["_count", "_min", "_max"],
  PostGroupBy: ["id", "title", "intro", "image", "tags", "content", "status", "readingTime", "authorId", "createdAt", "updatedAt", "_count", "_min", "_max"],
  ...
  ProjectCountAggregate: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "authorId", "createdAt", "updatedAt", "_all"],
  ProjectMinAggregate: ["id", "title", "intro", "image", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
  ProjectMaxAggregate: ["id", "title", "intro", "image", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
  PostCountAggregate: ["id", "title", "intro", "image", "tags", "content", "status", "readingTime", "authorId", "createdAt", "updatedAt", "_all"],
  PostMinAggregate: ["id", "title", "intro", "image", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
  PostMaxAggregate: ["id", "title", "intro", "image", "status", "readingTime", "authorId", "createdAt", "updatedAt"]
};
...
const inputsInfo = {
  ...
  ProjectWhereInput: ["AND", "OR", "NOT", "id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "authorId", "createdAt", "updatedAt", "author"],
  ProjectOrderByWithRelationAndSearchRelevanceInput: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "authorId", "createdAt", "updatedAt", "author", "_relevance"],
  ProjectWhereUniqueInput: ["id", "AND", "OR", "NOT", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "authorId", "createdAt", "updatedAt", "author"],
  ProjectOrderByWithAggregationInput: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "authorId", "createdAt", "updatedAt", "_count", "_max", "_min"],
  ProjectScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
  PostWhereInput: ["AND", "OR", "NOT", "id", "title", "intro", "image", "tags", "content", "status", "readingTime", "authorId", "createdAt", "updatedAt", "author"],
  PostOrderByWithRelationAndSearchRelevanceInput: ["id", "title", "intro", "image", "tags", "content", "status", "readingTime", "authorId", "createdAt", "updatedAt", "author", "_relevance"],
  PostWhereUniqueInput: ["id", "AND", "OR", "NOT", "title", "intro", "image", "tags", "content", "status", "readingTime", "authorId", "createdAt", "updatedAt", "author"],
  PostOrderByWithAggregationInput: ["id", "title", "intro", "image", "tags", "content", "status", "readingTime", "authorId", "createdAt", "updatedAt", "_count", "_max", "_min"],
  PostScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "title", "intro", "image", "tags", "content", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
  ...
  ProjectCreateInput: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "createdAt", "updatedAt", "author"],
  ProjectUpdateInput: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "createdAt", "updatedAt", "author"],
  ProjectCreateManyInput: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
  ProjectUpdateManyMutationInput: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "createdAt", "updatedAt"],
  PostCreateInput: ["id", "title", "intro", "image", "tags", "content", "status", "readingTime", "createdAt", "updatedAt", "author"],
  PostUpdateInput: ["id", "title", "intro", "image", "tags", "content", "status", "readingTime", "createdAt", "updatedAt", "author"],
  PostCreateManyInput: ["id", "title", "intro", "image", "tags", "content", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
  PostUpdateManyMutationInput: ["id", "title", "intro", "image", "tags", "content", "status", "readingTime", "createdAt", "updatedAt"],
  ...
  ProjectCountOrderByAggregateInput: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
  ProjectMaxOrderByAggregateInput: ["id", "title", "intro", "image", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
  ProjectMinOrderByAggregateInput: ["id", "title", "intro", "image", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
  ...
  PostCountOrderByAggregateInput: ["id", "title", "intro", "image", "tags", "content", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
  PostMaxOrderByAggregateInput: ["id", "title", "intro", "image", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
  PostMinOrderByAggregateInput: ["id", "title", "intro", "image", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
  ...
  ProjectCreateWithoutAuthorInput: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "createdAt", "updatedAt"],
  ProjectCreateOrConnectWithoutAuthorInput: ["where", "create"],
  ProjectCreateManyAuthorInputEnvelope: ["data", "skipDuplicates"],
  PostCreateWithoutAuthorInput: ["id", "title", "intro", "image", "tags", "content", "status", "readingTime", "createdAt", "updatedAt"],
  ...
  ProjectScalarWhereInput: ["AND", "OR", "NOT", "id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
  PostUpsertWithWhereUniqueWithoutAuthorInput: ["where", "update", "create"],
  PostUpdateWithWhereUniqueWithoutAuthorInput: ["where", "data"],
  PostUpdateManyWithWhereWithoutAuthorInput: ["where", "data"],
  PostScalarWhereInput: ["AND", "OR", "NOT", "id", "title", "intro", "image", "tags", "content", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
  ...
  ProjectCreateManyAuthorInput: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "createdAt", "updatedAt"],
  PostCreateManyAuthorInput: ["id", "title", "intro", "image", "tags", "content", "status", "readingTime", "createdAt", "updatedAt"],
  ProjectUpdateWithoutAuthorInput: ["id", "title", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "createdAt", "updatedAt"],
  PostUpdateWithoutAuthorInput: ["id", "title", "intro", "image", "tags", "content", "status", "readingTime", "createdAt", "updatedAt"]
};
