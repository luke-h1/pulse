...
const inputsInfo = {
  ...
  ProjectMinOrderByAggregateInput: ["id", "title", "slug", "intro", "image", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
  ...
  ProjectScalarWhereInput: ["AND", "OR", "NOT", "id", "title", "slug", "intro", "image", "content", "githubUrl", "siteUrl", "appStoreUrl", "playStoreUrl", "tags", "status", "readingTime", "authorId", "createdAt", "updatedAt"],
