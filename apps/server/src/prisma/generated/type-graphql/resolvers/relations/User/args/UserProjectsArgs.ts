...
export class UserProjectsArgs {
  ...
  distinct?: Array<"id" | "title" | "slug" | "intro" | "image" | "content" | "githubUrl" | "siteUrl" | "appStoreUrl" | "playStoreUrl" | "tags" | "status" | "readingTime" | "authorId" | "createdAt" | "updatedAt"> | undefined;
}
